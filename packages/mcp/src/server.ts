...
export function createServer(relayClient: RelayClient): Server {
  ...
  const tools: Tool[] = [
    ...
    { name: 'toreva_perps_query_funding', description: 'Query current funding rates across Drift, Jupiter Perps, and Flash Trade for a token. Read-only. Free.', inputSchema },
